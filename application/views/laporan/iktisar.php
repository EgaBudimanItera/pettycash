...
<title>Iktisar Pengeluaran Kas Kecil</title>
</head>
      ...
      <tr rowspan=2>
        <td colspan="2">
          <table border="0" width="100%">
            ...
            <tr>
              <td align="center"><strong>IKHTISAR PENGELUARAN PETTY CASH</strong></td>
            </tr>
            <tr>
              ...
              <td>
                <table width="100%" border="1px">
                  <tr>
                    ...
                    <td align="center" width="5%"><b>BBK No</b></td>
                    ...
                    <td align="center" width="10%"><b>Biaya Pos (Kurir)</b></td>
                    <td align="center" width="5%"><b>Biaya Sampah</b></td>
                    <td align="center" width="10%"><b>Biaya Air Bersih</b></td>
                    <td align="center" width="10%"><b>Iuran Jaga Malam</b></td>
                    <td align="center" width="5%"><b>Biaya Koran</b></td>
                    <td align="center" width="5%"><b>Biaya Parkir</b></td>
                    <td align="center" width="10%"><b>Jumlah Pengeluaran</b></td>
                  </tr>
                  <?php
                    $no=1;
                    $dinas=0;
                  ...
                  <tr>
                    ...
                    <td align="right"><?php echo number_format($jtotal)?></td>
                  </tr>
                  <?php
                    }
                  ?>
                  <tr>
                    ...
                    <td align="right"><?=$jsemua?></td>
                  </tr>
                  <tr>
                    <td colspan="3">POSISI PER PETTY CASH</td>
